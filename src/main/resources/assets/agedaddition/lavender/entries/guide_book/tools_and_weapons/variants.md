```json
{
  ...
  "category": "agedaddition:tools_and_weapons",
  "ordinal": 0
}
```
...
Only obtainable after you killed the [void shadow](^agedaddition:battle/void_shadow).
...
Obtainable in [Amarite Geodes](^agedaddition:produce/amarite).
...
Obtainable in [The Labyrinth](^agedaddition:battle/chaos_spawner).
