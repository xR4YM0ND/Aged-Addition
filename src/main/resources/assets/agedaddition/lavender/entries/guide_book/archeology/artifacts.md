```json
{
  ...
  "category": "agedaddition:archeology",
  "ordinal": 1
}
```

Artifact Shards can be found in [suspicious blocks](^agedaddition:archeology/suspicious) / breaking pots / using [sieves](^agedaddition:produce/sieve).
