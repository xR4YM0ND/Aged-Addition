```json
{
  ...
  "category": "agedaddition:hydration",
  "ordinal": 0
}
```
...
As soon as you can use water bottles on a [campfire](^agedaddition:hydration/campfire) to make purified water which is save to drink.