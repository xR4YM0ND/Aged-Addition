```json
{
  ...
  "category": "agedaddition:armors",
  "ordinal": 2
}
```

Thin Armor doesn't affect your [{gold}body temperature{}](^agedaddition:temperature/body_temperature).


Only the Wanderer Armor decreases your [{gold}body temperature{}](^agedaddition:temperature/body_temperature) by a bit.
