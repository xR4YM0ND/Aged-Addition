...
Thick Armor increases your [{gold}body temperature{}](^agedaddition:temperature/body_temperature) amount gained twice as [standard armor](^agedaddition:armors/standard).
